...
exports.WorkflowInstancesApi = {
     ...
     * @returns The request builder, use the `execute()` method to trigger the request.
     */
    getV1WorkflowInstancesByWorkflowInstanceId: (workflowInstanceId, queryParameters) => new openapi_1.OpenApiRequestBuilder('get', '/v1/workflow-instances/{workflowInstanceId}', {
